...
- [iOS build pipeline](ios-build-pipeline.md) — signing approach, SPM cascade root cause, destination=upload gotcha, required secrets
...
- [iOS tracking policy](ios-tracking-policy.md) — do not request ATT or access IDFA; keep attribution/analytics disclosures consistent with that choice
